...
class airline():
    def __init__(self,root):
        ...
        idLabel = tk.Label(mainFrame,text="Passport Number:",bg="sky blue",font = ("Arial",15))
        idLabel.grid(row=2,column=0,padx=10,pady=30)
    ...
    def showFlight(self):
        con = pymysql.connect(host="localhost",user="root",passwd="100780",database="db")
        cur = con.cursor()
